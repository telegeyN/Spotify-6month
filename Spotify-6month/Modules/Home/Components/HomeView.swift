...
//        view.searchTextField.addTarget(self, action: #selector(searchBarEditingChanged), for: .editingChanged)
    ...
    private let categoryItems = [
        CategoryItem(logo: UIImage(named: "1"), songName: "Bad Guy", artistName: "Billie Eilish"),
        CategoryItem(logo: UIImage(named: "2"), songName: "Scorpion", artistName: "Drake"),
        CategoryItem(logo: UIImage(named: "3"), songName: "Snowchild", artistName: "The Weeknd")
    ]
